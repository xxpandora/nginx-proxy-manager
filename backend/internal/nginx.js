			...
			const locationRendering = async () => {
				for (let i = 0; i < host.locations.length; i++) {
					let locationCopy = Object.assign({}, {access_list_id: host.access_list_id}, {certificate_id: host.certificate_id}, 
						{ssl_forced: host.ssl_forced}, {caching_enabled: host.caching_enabled}, {under_attack: host.under_attack}, {rate-limit_advanced: host.rate-limit_advanced}, {rate-limit_basic: host.rate-limit_basic}, {managed_waf: host.managed_waf}, 
