			...
			const locationRendering = async () => {
				for (let i = 0; i < host.locations.length; i++) {
					let locationCopy = Object.assign({}, {access_list_id: host.access_list_id}, {certificate_id: host.certificate_id}, 
						{ssl_forced: host.ssl_forced}, {caching_enabled: host.caching_enabled}, {under_attack: host.under_attack}, {managed_waf: host.managed_waf}, {rate_limit_advanced: host.rate_limit_advanced},
