...
local ip_whitelist = {
--GTmetrix IP
"172.255.48.140","172.255.48.143","67.205.29.157",
--Bing Bot IP
...
"148.251.212.0/27",
--UptimeRobot IP
"69.162.124.224/28","63.143.42.240/28","216.245.221.80/28","208.115.199.16/28","216.144.248.16/28",
--Cron-job.org IP
"116.203.129.16",
}
...
<head>
  ...
  <body style="margin:0">
    <iframe src="https://cdn.pegaflare.com/check/" style="border:0;width:100%;height:100%;overflow:hidden;position:absolute">Your browser doesn't support iFrames.</iframe>
    <div>
      <div id="status" style="color:#bd2426;font-size:200%">
        <noscript>Please turn JavaScript on and reload the page. <br>
        </noscript>
      </div>
    </div>
  </body>
